...
/* Macro to indicate that a variable is intentionally unused */
...
/* Structure for format specifier and associated function */
struct fmt {
    char fmt;
    int (*fn)(va_list, char[], int, int, int, int);
};

/* Typedef for the format specifier structure */
typedef struct fmt fmt_t;

/* Main printf-like function declaration */
